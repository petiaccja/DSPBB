...
TEST_CASE("Form Type III small", "[Hilbert]") {
	const auto filter = HilbertFirWinIII<float, TIME_DOMAIN>(19, windows::hamming);
...
TEST_CASE("Form Type IV small", "[Hilbert]") {
	const auto filter = HilbertFirWinIV<float, TIME_DOMAIN>(10, windows::hamming);
